"""Dataset wrappers for Slice 6 (composability study).

T6.1 ships `StubCSI` for end-to-end pipeline plumbing on random tensors —
same shape convention as Slice 1 and Slice 5. T6.2 adds the real
Widar3.0 cross-subject + interaction term loader (train/test split by recording date,
