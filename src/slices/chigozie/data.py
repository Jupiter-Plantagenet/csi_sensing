...
T2.1 ships `StubCSI` for end-to-end pipeline plumbing on random tensors —
same shape convention as Slice 1 and Slice 5. T2.2 adds the real
Widar3.0 cross-environment loader (train/test split by recording date,
