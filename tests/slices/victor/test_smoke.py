"""Smoke test for Slice 6's T6.1 scaffold.

Confirms the SimCLR pipeline runs end-to-end on stub data. T6.5 will add
...
from src.slices.victor.encoder import TinyCNN, count_parameters
from src.slices.victor.run import main
from src.slices.victor.ssl import SimCLR, make_views, nt_xent_loss
