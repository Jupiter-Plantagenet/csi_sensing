"""Smoke test for Slice 2's T2.1 scaffold.

Confirms the SimCLR pipeline runs end-to-end on stub data. T2.5 will add
...
from src.slices.chigozie.encoder import TinyCNN, count_parameters
from src.slices.chigozie.run import main
from src.slices.chigozie.ssl import SimCLR, make_views, nt_xent_loss
